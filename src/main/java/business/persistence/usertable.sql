...
-- Schema typo
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `typo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `fog_carport` ;
...
CREATE TABLE IF NOT EXISTS `fog_carport`.`query` (
  ...
  `wantBuilder` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `Id_UNIQUE` (`id` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 36
...
-- Table `typo`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `typo`.`users` (
